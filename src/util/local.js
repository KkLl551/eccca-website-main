...
const strings = new LocalizedStrings({
  en: {
    ...
    aboutTitle: "About Us",
    aboutText:
      "In 1976, responding to the needs of the Chinese community in Windsor, the Essex County Chinese Canadian Association was founded to promote Chinese culture and to help integrate Chinese into mainstream society. Dr. Chosen Lau was one of the founders and the first president of the association. One of the first steps of integration was the introduction of the celebration of Chinese New Year in the oriental tradition. In 1976 the first Annual New Year Banquet was held at the Cleary International Centre. Dr. Edward Ng was instrumental in organizing the successful Chinese cabaret in 1980, to promote cultural exchange between the East and West.",
    aboutText2:
    ...
    supportTitle: "Support & Community Resources",
    ...
    treasurer:"Treasurer",
    enSecretary:"Secretary",
    cnSecretary:"Chinese Secretary",
    directorACE:"Director Art, Culture, Event Planning",
    directorYouth:"Director Youth Program",
    directorPIT:"Director Public Relation, Information Technology",
    directorIt:"Director Information Technology, Special Event Planning",
    directorSE:"Director Senior Program, Event Coordinator",
    directorFRF:"Director Finance, Recreation, Fundraising",
    directorTF:"Director Technical, Facilities Advisor",
    directorRF:"Director Recreation, Fundraising",
    director:"Director",
    timeTable: "Activity Time Table",
    menu:"Menu",
    aboutMember:"About Member",
    membershipform:"Membership Application",
    member1:"To join the ECCCA membership, please download the form, fill it and return it to ECCCA centre",
    aboutEvergreen:"The Evergreen Centre is an extension of the ECCCA that offers a variety of activities for older adults to share their talents and time; to build relationships and improve their quality of life. We are committed to providing programs and supports to older Chinese in their efforts to remain active and independent.  Please contact the ECCCA office to join the Centre.",
    front:"Front row",
    back:"Back Row",
    left:"(Left to Right)",
    tableTennis:"Table Tennis Club",
    tableTennisNote:"Please see below for the Table Tennis Club availble sessions. For reservation, please email info@eccca.net",
    weeklyCalandar:"Weekly Activity Calandar",
    tableTennisCamp:"Table Tennis Training Camp",
  },
  ch: {
    NavHome: "首頁",
    NavAbout: "關於我們",
    ...
    aboutTitle: "關於我們",
    aboutText:
      "1976年，為了響應溫莎中國群體的號召，雅斯郡華人協會成立了。協會主旨弘揚中華文化與幫助中國群體融入主流社會。劉超信醫生成為了創辦人之一以及第一任協會主席。為了融入主流社會，協會作出了第一步舉動---宣揚慶祝中國新年的東方文化。在同一年，第一屆年度新年宴會在Cleary International Centre舉行。1980年，促進東西方文化交流的中國歌舞表演取得圓滿成功，同時Edward吳醫生對此活動組織的成功也功不可沒。",
    aboutText2:
    ...
    directorIt:"幹事資訊科技特別活動策劃",
    directorSE:"幹事老年人計劃活動協調員",
    directorFRF:"幹事金融娛樂籌款",
    directorTF:"幹事技術設施顧問",
    directorRF:"幹事娛樂籌款",
    directorPIT:"幹事公共關係資訊科技",
    timeTable: "活動時間表",
    menu:"選單",
    aboutMember:"關於會員",
    membershipform:"會員入會申請表",
    member1:"如需加入雅斯郡華人協會會員，請下載表格並填寫後交回雅斯郡華人協會中心",
    aboutEvergreen:"松柏中心為五十五歲以上的華裔長者提供多元化服務。藉著不同形式的活動，讓他們發揮所長和善用餘閒，並藉此建立良好人際關係及改善其生活質素。請聯絡雅斯郡華人協會辦公室加入松柏中心。",
    front:"前排",
    back:"後排",
    left:"(由左到右)",
    tableTennis:"乒乓球社",
    tableTennisNote:"請參閱下面的乒乓球俱樂部時間表。如想預約，請發送電子郵件至 info@eccca.net",
    weeklyCalandar:"每週活動日曆",
    tableTennisCamp:"乒乓球訓練營",
  }
});
